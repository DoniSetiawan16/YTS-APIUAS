...
@section('script')
	<script type="text/javascript">
	    ...
	    @if(Route::current()->getParameter('page_number'))
	    	var url = "https://yts.ag/api/v2/list_movies.json?page={{ Route::current()->getParameter('page_number') }}&limit=18";
	    @else
	    	var url = "https://yts.ag/api/v2/list_movies.json?limit=18";
	    @endif
	    
	    $.getJSON(url, function(result){
	        $.each(result.data.movies, function(index, value){
	        	html = html + "<div class='col s12 m2'>"+
		          "<div class='card'>"+
